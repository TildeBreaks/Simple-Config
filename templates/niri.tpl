...
// https://github.com/YaLTeR/niri/wiki/Configuration:-Outputs
 ...
 output "DP-1" {
    mode "3440x1440@180" // Set resolution and refresh rate
    scale 1 // No scaling (use 2 for HiDPI)
    position x=0 y=1080

}
 output "DP-2" {
    mode "1920x1080@200" // Set resolution and refresh rate
    scale 1 // No scaling (use 2 for HiDPI)
    position x=760 y=0
    transform "180"
...
binds {
    ...
    MOD+ALT+S                           hotkey-overlay-title="Lock Screen: steam" { spawn-sh "steam"; }
    MOD+ALT+D                           hotkey-overlay-title="Lock Screen: discord" { spawn-sh "discord"; }
...
// https://github.com/YaLTeR/niri/wiki/Configuration:-Miscellaneous#spawn-sh-at-startup
    ...
    spawn-sh-at-startup "swww img home/breaks/Pictures/Wallpapers/aishot-3264.jpg" // Set wallpaper
...
// https://github.com/YaLTeR/niri/wiki/Configuration:-Window-Rules
    ...
    window-rule {
        geometry-corner-radius 8 // Set every window radius to 20
